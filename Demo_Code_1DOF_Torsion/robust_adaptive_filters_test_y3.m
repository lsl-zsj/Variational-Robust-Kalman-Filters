function robust_adaptive_filters_test_y3()
% Brief: This code demonstrates the ability of STKF-AR2 to handle time-varying measurement noise 
% with occasional outliers.
% Details:
%    None
% 
% Syntax:  
%     robust_adaptive_filters_test_y3()
% 
% Inputs:
%    None
% 
...
uk=0*ones(1,len);
[state,z,d,amp]=measurement_generation_y3(kfa,uk);
stateaug=[d;state];
...
kfa.sigma_p=[10^8 10^8 10^8 10^8 10^8]';
kfa.sigma_r=[2 2]';
rbkf1=rbkf1_forward(kfa,uk,z);
%% RBKF2:  (0,2)
kfa.sigma_p=[1.999 1.999 1.999 1.999 1.999]';
kfa.sigma_r=[0.5 0.5]';
...
hold off;
set(gca,'fontsize',14)
legend('STKF-AR2 ${\sigma_{v_1}}^2$', 'STKF-AR2 ${\sigma_{v_2}}^2$','Truth','Interpreter', 'latex',...
    'Orientation','horizontal');
